...
![](buildingtool.png)
도구 조립대 중앙에 완성된 도구를 놓고 주변에 적절한 아이템을 놓아 수식어(modifier, 팅커스 도구의 업그레이드)를 적용시킬 수 있습니다.
재료의 정석 책에서 도구에 적용시킬 수 있는 수식어들을 확인하세요.
도구에는 한정된 개수의 수식어만을 적용시킬 수 있습니다. 도구 조립대에 도구를 올려놓아 우측 정보창에서 남은 수식어 슬롯을 알 수 있습니다.
![](modifiers.png)
...
도구에 커서를 올리면 능력치와 수식어, 도구 레벨들을 볼 수 있습니다. Tinkers' Tool Leveling 모드가 설치되어 있다면(이 모드팩에도 있습니다), 도구를 사용할수록 도구 경험치가 오릅니다. 도구 레벨이 오리면 추가적인 수식어 슬롯을 얻을 수 있습니다!
![](toolxp.png)

완전히 수리된 도구와 원하는 도구 부품을 합치는 방식으로 도구 부품을 교체할 수 있습니다. 교체당한 도구 부품과 해당 부품의 특성들은 사라집니다.
![](partswap.png)

능력치나 특성을 바꾸지 않고 채굴 등급을 업그레이드하고 싶다면, 연마 키트(Sharpening Kit)를 사용해 도구의 부품 교체 없이 채굴 등급만을 바꿀 수 있습니다. 수식어 슬롯을 차지하지 않을 뿐만 아니라, 여러 번 등급을 바꿀 수도 있습니다. 동일한 재료로 만들어진 도구(도구 머리만 같으면 됨)와 연마 키트를 조합하면 도구 조립대/조립소 없이도 도구의 내구도를 수리할 수 있습니다.
![](sharpeningkit.png)
